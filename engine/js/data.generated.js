...
export const DATA = {
        ...
        "forms": [
          {
            ...
            "sourceQuote": "مفاعيلن مفاعيلن فعولن"
          },
          {
            "role": "ajz",
            "feet": [
            ...
            "sourceQuote": "مفاعيلن مفاعيلن فعولان"
          }
        ],
        "expectedSyllableCount": 11,
        "status": "OK",
        "note": "أقرّه صاحب القائمة بحرًا مستقلًّا لا ضربًا محذوفًا من الوافر. وشاهده شطر «حياتي كلّها صبْرو جلاده»: يقطّعه التطبيق المرجعي حيا|تي|كل ، لها|صب|رو ، جلا|ده = مفاعيلن مفاعيلن فعولن، واسمه «الصخري» هناك. والعجز مستنبَط على قاعدة القائمة نفسها — العجز هو الصدر مع زيادة ساكن (فعولن ← فعولان) — ولم يَرِد نصًّا."
      }
    ],
    "notInSource": []
  },
  "scoring": {
    "version": 1,
    "description": "معاملات معادلة الدرجة. ملف مستقل عمدًا: تعديل أي رقم هنا يغيّر الترتيب دون إعادة بناء المحرك. والدرجة درجتان لا واحدة: `score` ما يُعرض على الشاعر — عيوبُ بيته وحدها — و`rankScore` ما يُرتَّب به، تدخله الرخصُ المأذون فيها. المعادلة كاملةً في docs/SCORING.md ولا تقرأ أي رقم من خارج هذا الملف.",
    "weights": {
      "substitution": 1,
      "insertion": 1.2,
      "deletion": 1.2,
    ...
    "rationale": {
      ...
      "zihaf_not_free": "الزحاف مسموح لا مُستحبّ. فهو **لا يُنقص الدرجة المعروضة**: البيت الذي جاء على رخصةٍ مأذون فيها موزونٌ تامّ الوزن لا بيتٌ فيه عيب. وإنما تُحسب له كلفةٌ صغيرة في **درجة الترتيب** وحدها، لتتقدّم القراءة السالمة على المزاحَفة عند تساوي كل شيء آخر — وبها يُفرَّق بين الصدر والعجز أيضًا، إذ الفرق بينهما علّةٌ في الضرب. والخلط بين الدرجتين كان يُنزل بيتًا سليمًا إلى ٩٨٪ لأن في ضربه حذفًا، والحذف من البحر لا عليه.",
      ...
      "licensed_vs_defect": "ما يُطرح من الدرجة المعروضة: الزحافُ والعلّةُ في موضعهما، ورخصُ القراءة (قصرُ المدّ، وقراءتُه صامتًا، والإشباعُ المفترض)، واتّساقُ قراءة الكلمة. وكلها إمّا رخصةٌ للشاعر أو افتراضٌ من المحرك — وليس شيء منها عيبًا في البيت. وما يبقى فيها: خللُ المحاذاة (إبدالٌ وزيادةٌ ونقص)، والمقاطعُ الفائضة، والتفعيلاتُ الخاوية، ووقوعُ العلّة في غير موضعها — وهذه عيوبٌ حقيقية.",
      "hashw_variation": "النبطي لا يأذن بالزحاف والعلّة إلا في التفعيلة الأولى وفي العروض والضرب. فما وقع منهما في حشو الشطر ليس رخصةً بل **شبهةُ كسر**: يُخرج البيت من «موزون» إلى «مشتبه»، وينزل بدرجته إلى ما دون ٨٠٪. وكلفتُه حصّةٌ من البيت لا رقمٌ مطلق (خُمسه)، لأن المطلق يختلف أثره باختلاف طول البحر — فتنزل الدرجة إلى ما دون ٨٠٪ في البحر الطويل والقصير سواءً، وتنزل مرّتين إن تكرّر. وهذا يقلب معامل الموضع في الصور خاصّةً: معاملُ الموضع يشدّد في العروض والضرب لأن **خلل المحاذاة** فيهما أشدّ على السمع، وهذا يشدّد في الحشو لأن **الرخصة** فيه غير مأذون بها."
    }
  },
  "encodings": {
  ...
  "lexicon": {
    ...
    "nabatiDialect": {
      ...
      "knownGaps": [
        ...
        "تسكين أواخر الكلمات في النبطي أكثر منه في الفصيح — **مأخوذٌ به ترجيحًا لا حكمًا**: عند تساوي بحرين تساويًا تامًّا تُقدَّم القراءة الأقلّ افتراضًا لحركةٍ على آخر الكلمة (`scoring.ranking.preferFinalSukun`)، فتُقرأ «بسّ الدهر جحّاد» دَ‑هَرْ‑جِحْ لا دَهْ‑رِ‑جِحْ. ولا يمسّ درجةً ولا يُسقط قراءة، وإنما يحلّ محلّ ترتيب القائمة. ويقوم عليه أيضًا `scoring.weights.assumedIshbaa`: إشباعُ حركةٍ مفترضة آخر الشطر رخصةٌ تُكلَّف، فتُقرأ «جلاده» جَ‑لَا‑دَهْ لا جَ‑لَا‑دَ‑هَا (golden: sakhri_three_feet، ويُقاس المعاملُ نفسه في اختبار الرخص على «قفا نبك … ومنزل»). ومستندهما تقطيعان مرجعيّان (golden: article_after_proclitic و sakhri_three_feet) — NEEDS_VALIDATION. يحسمه: عشرة أشطر مقطَّعة فيها كلمةٌ آخرها ساكنان (دَهْر، بَحْر، شَمْس) في وسط الشطر.",
  ...
  "goldenCases": {
    ...
    "verses": [
      ...
      {
        "id": "sakhri_three_feet",
        "title": "بحر «الصخري»: مفاعيلن مفاعيلن فعولن",
        ...
        "why": "تقطيع التطبيق المرجعي: حيا|تي|كل ، لها|صب|رو ، جلا|ده، واسمه «الصخري» هناك. وقبل إقراره بحرًا مستقلًّا كان المحرك يقرؤه الوافرَ بضربٍ مقبوض (مفاعلن) — وذاك يوجب حركةً مفترضة على هاء «جلاده» ثم إشباعها، فيزيد حرفًا لا رسم له.",
        "meterNote": "الوافر يبقى في القائمة على حاله (مفاعيلن ×٣)، والصخري بحرٌ مستقلّ لا ضربٌ محذوف منه — بتقرير صاحب القائمة.",
        "source": "app",
        "expectedMeter": "al_sakhri",
        "expectedConfidenceRange": [
          1,
          1
        ]
      ...
      {
        "id": "hashw_variation_is_suspect",
        "title": "الرخصة في حشو الشطر شبهةُ كسر لا رخصة",
        "input": "البارحة رحْت و جيت بس مدري",
        "expectedTafaeel": [
          "مستفعلن",
          "مستفعلن",
          "مفعولن"
        ...
        "why": "الطيّ في التفعيلة الوسطى. والنبطي لا يأذن بالزحاف والعلّة إلا في التفعيلة الأولى وفي العروض والضرب، فما وقع منهما في الحشو شبهةُ كسر. وكان المحرك يعطيه ١٠٠٪ «موزون».",
        "meterNote": "البحر يبقى هو البحر: قربُ البيت منه لم يتغيّر (rankScore فوق ٠٫٩٧)، وإنما تغيّر الحكم عليه.",
        "source": "user"
      }
    ],
    "pending": {
