...
export const DATA = {
  ...
  "meters": {
    ...
    "meters": [
      ...
      {
        "id": "al_madeed_nabati",
        "name": "المديد النبطي - الثلاثي المزيد",
        "aliases": [],
        "enabled": true,
        "sourceIndex": 35,
        "forms": [
        ...
        "expectedSyllableCount": 12,
        "status": "OK",
        "note": "زِيد بعد القائمة الأصلية. شاهده شطر «العب المنكوس واحبّ روباعه»: يقطّعه التطبيق المرجعي ال|عبل|من ، كو|سوا|حب ، برو|با|عه = فاعلاتن فاعلاتن مفاعيلن، والاسم اسمُه هناك. والعجز مستنبَط على قاعدة القائمة نفسها — العجز هو الصدر مع زيادة ساكن (مفاعيلن ← مفاعيلان) — ولم يَرِد نصًّا."
      }
    ],
    "notInSource": []
  },
  ...
  "goldenCases": {
    ...
    "verses": [
      ...
      {
        "id": "madeed_nabati_thulathi",
        "title": "بحر «المديد النبطي - الثلاثي المزيد»: فاعلاتن فاعلاتن مفاعيلن",
        "input": "العب المنكوس واحبّ روباعه",
        "expectedMeter": "al_madeed_nabati",
        "expectedTafaeel": [
          "فاعلاتن",
          "فاعلاتن",
          "مفاعيلن"
