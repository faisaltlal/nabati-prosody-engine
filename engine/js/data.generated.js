  ...
  "lexicon": {
    ...
    "nabatiDialect": {
      ...
      "knownGaps": [
        ...
        "حذف همزة القطع في أول الكلمة في النطق العامي — **مُعالَج**: الألف بعد ساكن همزةٌ لا مدّ، وقد تسقط في الوصل فيأخذ الساكنُ قبلها حركتَها. والقراءتان تُعرضان على الوزن وهو الذي يحسم، فلم تُفرض إحداهما. أثبته بيت «البارحه يوم الدجا غطّ الاطلال» — المسحوب بالإسقاط، والرجز بغيره."
      ]
    }
  },
  "rhyme": {
