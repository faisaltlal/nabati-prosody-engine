  ...
  "goldenCases": {
    ...
    "pending": {
      ...
      "items": [
        ...
        {
          "need": "إقرارُ بحرٍ من ثلاث تفعيلات: «مستفعلن فاعلن فعلن» (LLSL LSL LL) — يسمّيه التطبيق المرجعي «الهجيني»، وتفعيلاته عنده مفاعلن (خبن مستفعلن) فاعلن فاعل",
          "evidence": "شطر «صعيب مهما تساهلته» — المرجع يقطّعه صعي|بمه ، ما|تسا ، هل|ته بدرجة تامّة. والقائمة المعتمدة (٣٣ بحرًا) ليس فيها هذا الشكل ولا شكلٌ من تسعة مقاطع يقاربه، فأقرب ما وجده المحرك «البسيط - طرق 1» بقراءةٍ تقرأ «تساهلته» تَسَاهَلَتَهَا وتلزمها الخبل — ٩٦٪.",
          "unblocks": "قراءة الأشطر الثلاثية على وزن مستفعلن فاعلن + ضرب مقطوع. والإضافة تعديلُ بياناتٍ وحدها (البند ٣٠): صيغتان، صدرٌ [mustafilun, failun, faalun] وعجزٌ [mustafilun, failun, maful].",
          "whyNotAdded": "البند ٢٦: البحر لا يُخترع. والقائمة المعتمدة قرارُ صاحبها، وقد نصّ على أنها تُلغي ما قبلها — فزيادةُ بحرٍ عليها إقرارٌ منه لا استنتاجٌ منّي."
        }
      ]
    }
  }
