  ...
  "meters": {
    ...
    "meters": [
      ...
      },
      {
        ...
        "note": "صُحّح بتأكيد المستخدم: المصدر كتب «مستفعلن فاعلن مستفعلن فاعلن» والصواب «مستفعلن فاعلن مستفعلن فعلن». ولم يُعطَ سطر عجز مع التصحيح، فلم يُستنتج له عجز.",
        "duplicateOf": "al_baseet_b",
        "validation": {
          "issue": "بعد تصحيح المستخدم صار هذا مطابقًا تطابقًا تامًّا للوجه الثاني من «البسيط» في القائمة: كلاهما «مستفعلن فاعلن مستفعلن فعلن»، وكلاهما بصيغة واحدة بلا عجز. وهذا يرجّح أنهما مدخل واحد: «غير مصنف - 4» هو البسيط، وعلامة التنبيه ⚠️ في المصدر تدعم ذلك.",
          "kept": "حُفظ المدخلان. لم يُدمجا ولم يُحذف أحدهما — التسمية قرار المستخدم.",
          "resolvedBy": "تأكيد أنهما واحد، فيُبقى مدخل واحد ويصير الآخر اسمًا بديلًا"
        }
      },
      {
      ...
      },
      {
        ...
        "validation": {
          "issue": "بعد تصحيح المستخدم صار هذا مطابقًا تطابقًا تامًّا للوجه الثاني من «البسيط» في القائمة: كلاهما «مستفعلن فاعلن مستفعلن فعلن»، وكلاهما بصيغة واحدة بلا عجز. وهذا يرجّح أنهما مدخل واحد: «غير مصنف - 4» هو البسيط، وعلامة التنبيه ⚠️ في المصدر تدعم ذلك.",
          "kept": "حُفظ المدخلان. لم يُدمجا ولم يُحذف أحدهما.",
          "resolvedBy": "تأكيد أنهما واحد"
        },
